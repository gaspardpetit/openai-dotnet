...
namespace OpenAI.Responses
{
    ...
    {
        public InternalLocalShellToolCallItemResource(InternalLocalShellToolCallItemResourceStatus status, string callId, InternalLocalShellExecAction action) : base(ResponseItemKind.LocalShellCall)
        {

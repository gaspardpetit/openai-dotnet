...
{
    public partial class ContainerClientGetContainersCollectionResultOfT : CollectionResult<ContainerResource>
    {
        ...
        public ContainerClientGetContainersCollectionResultOfT(ContainerClient client, int? limit, string order, string after, string name, RequestOptions options)
        {
            _client = client;
            _limit = limit;
            _order = order;
        ...
        public override IEnumerable<ClientResult> GetRawPages()
        {
            ...
            while (true)
            {
                ...
                bool hasMore = ((ContainerCollectionPage)result).HasMore;
                nextToken = ((ContainerCollectionPage)result).LastId;
        ...
        {
            return ((ContainerCollectionPage)page).Data;
        }

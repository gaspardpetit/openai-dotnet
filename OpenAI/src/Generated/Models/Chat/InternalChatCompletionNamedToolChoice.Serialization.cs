...
#pragma warning restore SCME0001 // Type is for evaluation purposes only and is subject to change or removal in future updates.
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    function = InternalCreateChatCompletionRequestToolChoiceFunction.DeserializeInternalCreateChatCompletionRequestToolChoiceFunction(prop.Value, prop.Value.GetUtf8Bytes(), options);
                    continue;
                }

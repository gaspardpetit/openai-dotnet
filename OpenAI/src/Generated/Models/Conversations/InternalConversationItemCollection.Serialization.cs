...
namespace OpenAI.Conversations
{
    public partial class InternalConversationItemCollection : IJsonModel<InternalConversationItemCollection>
    {
        ...
        protected virtual InternalConversationItemCollection PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                case "J":
                    ...
                    {
                        return DeserializeInternalConversationItemCollection(document.RootElement, data, options);
                    }
                default:
        ...
        public static explicit operator InternalConversationItemCollection(ClientResult result)
        {
            ...
            using JsonDocument document = JsonDocument.Parse(data, ModelSerializationExtensions.JsonDocumentOptions);
            return DeserializeInternalConversationItemCollection(document.RootElement, data, ModelSerializationExtensions.WireOptions);
        }
...
#pragma warning restore SCME0001 // Type is for evaluation purposes only and is subject to change or removal in future updates.
        ...
        protected virtual InternalConversationItemCollection JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            return DeserializeInternalConversationItemCollection(document.RootElement, null, options);
        }

        internal static InternalConversationItemCollection DeserializeInternalConversationItemCollection(JsonElement element, BinaryData data, ModelReaderWriterOptions options)
        {

...
namespace OpenAI.Evals
{
    public partial class InternalEvalJsonlRunDataSourceParamsSourceContent
    {
        ...
        internal InternalEvalJsonlRunDataSourceParamsSourceContent(IDictionary<string, BinaryData> item, IDictionary<string, BinaryData> sample, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            // Plugin customization: ensure initialization of collections
            Item = item ?? new ChangeTrackingDictionary<string, BinaryData>();

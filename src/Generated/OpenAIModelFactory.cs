...
namespace OpenAI
{
    internal static partial class OpenAIModelFactory
    {
        ...
        public static CreateContainerFileBody CreateContainerFileBody(string fileId = default, FileBinaryContent @file = default)
        {
        ...
        [Experimental("SCME0004")]
        public static CreateVoiceConsentRequest CreateVoiceConsentRequest(string name = default, FileBinaryContent recording = default, string language = default)
        {
        ...
        [Experimental("SCME0004")]
        public static CreateVoiceRequest CreateVoiceRequest(string name = default, FileBinaryContent audioSample = default, string consent = default)
        {
        ...
        [Experimental("SCME0004")]
        public static CreateVideoBody CreateVideoBody(VideoModel? model = default, string prompt = default, FileBinaryContent inputReference = default, VideoSeconds? seconds = default, VideoSize? size = default)
        {

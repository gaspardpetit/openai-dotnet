...
namespace OpenAI
{
    internal static partial class OpenAIModelFactory
    {
        ...
        public static InternalVadConfig InternalVadConfig(int? prefixPaddingMs = default, int? silenceDurationMs = default, float? threshold = default)
        {
            return new InternalVadConfig("server_vad", prefixPaddingMs, silenceDurationMs, threshold, additionalBinaryDataProperties: null);
        }

        public static InternalCreateTranscriptionResponseVerboseJson InternalCreateTranscriptionResponseVerboseJson(string language = default, TimeSpan duration = default, string text = default, IEnumerable<TranscribedWord> words = default, IEnumerable<TranscribedSegment> segments = default)
        {
        ...
        public static InternalListBatchesResponse InternalListBatchesResponse(IEnumerable<InternalBatchJob> data = default, string firstId = default, string lastId = default, bool hasMore = default)
        {
        ...
        {
            return new ChatToolCall(id, ChatToolCallKind.Function, function, additionalBinaryDataProperties: null);
        }
        ...
        {
            return new InternalCreateChatCompletionRequestWebSearchOptionsUserLocation1("approximate", approximate, additionalBinaryDataProperties: null);
        }
        ...
        {
            return new ChatTool(ChatToolKind.Function, function, additionalBinaryDataProperties: null);
        }

        public static InternalChatCompletionNamedToolChoice InternalChatCompletionNamedToolChoice(InternalChatCompletionNamedToolChoiceFunction function = default)
        {
            return new InternalChatCompletionNamedToolChoice("function", function, additionalBinaryDataProperties: null);
        }
        ...
        public static InternalResponseItemList InternalResponseItemList(IEnumerable<ResponseItem> data = default, bool hasMore = default, string firstId = default, string lastId = default)
        {
        ...
        public static InternalCreateModerationRequestInput2 InternalCreateModerationRequestInput2(InternalCreateModerationRequestInputImageUrl imageUrl = default)
        {
            return new InternalCreateModerationRequestInput2("image_url", imageUrl, additionalBinaryDataProperties: null);
        }
        ...
        public static InternalCreateModerationRequestInput3 InternalCreateModerationRequestInput3(string text = default)
        {
            return new InternalCreateModerationRequestInput3("text", text, additionalBinaryDataProperties: null);
        }
        ...
        public static InternalListVectorStoresResponse InternalListVectorStoresResponse(IEnumerable<VectorStore> data = default, string firstId = default, string lastId = default, bool hasMore = default)
        {
        ...
        public static InternalListVectorStoreFilesResponse InternalListVectorStoreFilesResponse(IEnumerable<VectorStoreFile> data = default, string firstId = default, string lastId = default, bool hasMore = default)
        {
        ...
        public static InternalRealtimeTranscriptionSessionCreateRequestClientSecretExpiresAt InternalRealtimeTranscriptionSessionCreateRequestClientSecretExpiresAt(InternalRealtimeTranscriptionSessionCreateRequestClientSecretExpiresAtAnchor? anchor = default, int? seconds = default)
        {
        ...
        public static InternalRealtimeResponseSession InternalRealtimeResponseSession(string id = default, string model = default, IEnumerable<InternalRealtimeRequestSessionModality> modalities = default, string instructions = default, ConversationVoice voice = default, RealtimeAudioFormat inputAudioFormat = default, RealtimeAudioFormat outputAudioFormat = default, InputTranscriptionOptions inputAudioTranscription = default, TurnDetectionOptions turnDetection = default, InputNoiseReductionOptions inputAudioNoiseReduction = default, IEnumerable<ConversationTool> tools = default, BinaryData toolChoice = default, float temperature = default, BinaryData maxResponseOutputTokens = default)
        {
        ...
        public static InternalRealtimeResponseItem InternalRealtimeResponseItem(string kind = default, string id = default)
        {
            return new UnknownRealtimeResponseItem("realtime.item", new InternalRealtimeItemType(kind), id, additionalBinaryDataProperties: null);
        }

        public static InternalRealtimeResponseMessageItem InternalRealtimeResponseMessageItem(string id = default, ConversationMessageRole role = default, IEnumerable<ConversationContentPart> content = default, ConversationItemStatus status = default)
        {
            content ??= new ChangeTrackingList<ConversationContentPart>();
        ...
        public static InternalRealtimeResponseFunctionCallItem InternalRealtimeResponseFunctionCallItem(string id = default, string name = default, string callId = default, string arguments = default, ConversationItemStatus status = default)
        {
        ...
        public static InternalRealtimeResponseFunctionCallOutputItem InternalRealtimeResponseFunctionCallOutputItem(string id = default, string callId = default, string output = default)
        {
        ...
        public static InternalRealtimeSessionCreateRequestClientSecretExpiresAt InternalRealtimeSessionCreateRequestClientSecretExpiresAt(InternalRealtimeSessionCreateRequestClientSecretExpiresAtAnchor? anchor = default, int? seconds = default)
        {
        ...
        public static OpenAI.FineTuneChatCompletionRequestAssistantMessage FineTuneChatCompletionRequestAssistantMessage(InternalFineTuneChatCompletionRequestAssistantMessageWeight? weight = default, BinaryData content = default, string refusal = default, string name = default, ChatOutputAudioReference audio = default, IEnumerable<ChatToolCall> toolCalls = default, ChatFunctionCall functionCall = default)
        {
            toolCalls ??= new ChangeTrackingList<ChatToolCall>();

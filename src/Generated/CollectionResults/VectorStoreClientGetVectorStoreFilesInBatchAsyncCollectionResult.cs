...
namespace OpenAI.VectorStores
{
    public partial class VectorStoreClientGetVectorStoreFilesInBatchAsyncCollectionResult : AsyncCollectionResult
    {
        ...
        public VectorStoreClientGetVectorStoreFilesInBatchAsyncCollectionResult(VectorStoreClient client, string vectorStoreId, string batchId, int? limit, string order, string after, string before, string filter, RequestOptions options)
        {
            _client = client;

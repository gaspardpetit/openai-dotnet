...
namespace OpenAI.VectorStores
{
    public partial class VectorStoreClientGetVectorStoresAsyncCollectionResult : AsyncCollectionResult
    {
        ...
        public VectorStoreClientGetVectorStoresAsyncCollectionResult(VectorStoreClient client, int? limit, string order, string after, string before, RequestOptions options)
        {
            _client = client;
            _limit = limit;
            _order = order;

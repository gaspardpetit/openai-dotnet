...
{
    public partial class InternalCreateThreadAndRunRequestToolResources : IJsonModel<InternalCreateThreadAndRunRequestToolResources>
    {
        ...
        internal static InternalCreateThreadAndRunRequestToolResources DeserializeInternalCreateThreadAndRunRequestToolResources(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                if (prop.NameEquals("code_interpreter"u8))
                {
                    ...
                    codeInterpreter = InternalCreateThreadAndRunRequestToolResourcesCodeInterpreter.DeserializeInternalCreateThreadAndRunRequestToolResourcesCodeInterpreter(prop.Value, options);
                    continue;
                }

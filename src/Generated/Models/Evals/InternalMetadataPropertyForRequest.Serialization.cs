...
namespace OpenAI.Evals
{
    public partial class InternalMetadataPropertyForRequest : IJsonModel<InternalMetadataPropertyForRequest>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(InternalMetadataPropertyForRequest)} does not support writing '{format}' format.");
            }
        ...
        InternalMetadataPropertyForRequest IJsonModel<InternalMetadataPropertyForRequest>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        protected virtual InternalMetadataPropertyForRequest JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<InternalMetadataPropertyForRequest>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(InternalMetadataPropertyForRequest)} does not support reading '{format}' format.");
            }
            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeInternalMetadataPropertyForRequest(document.RootElement, options);
        }

        internal static InternalMetadataPropertyForRequest DeserializeInternalMetadataPropertyForRequest(JsonElement element, ModelReaderWriterOptions options)
        {

...
#pragma warning restore SCME0001 // Type is for evaluation purposes only and is subject to change or removal in future updates.
        ...
        protected override ChatResponseFormat JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            return DeserializeInternalDotNetChatResponseFormatJsonObject(document.RootElement, null, options);
        }

        internal static InternalDotNetChatResponseFormatJsonObject DeserializeInternalDotNetChatResponseFormatJsonObject(JsonElement element, BinaryData data, ModelReaderWriterOptions options)
        {

...
{
    public partial class InternalChatOutputPredictionContent : ChatOutputPrediction, IJsonModel<InternalChatOutputPredictionContent>
    {
        internal InternalChatOutputPredictionContent() : this(InternalChatOutputPredictionKind.StaticContent, default, null)
        {
        }
...
#pragma warning restore SCME0001 // Type is for evaluation purposes only and is subject to change or removal in future updates.
            ...
            return new InternalChatOutputPredictionContent(kind, patch, content);
        }
        ...
        protected override ChatOutputPrediction PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                case "J":
                    ...
                    {
                        return DeserializeInternalChatOutputPredictionContent(document.RootElement, data, options);
                    }
                default:

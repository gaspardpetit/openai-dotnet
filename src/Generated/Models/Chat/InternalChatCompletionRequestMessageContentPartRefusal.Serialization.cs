...
{
    public partial class InternalChatCompletionRequestMessageContentPartRefusal : ChatMessageContentPart, IJsonModel<InternalChatCompletionRequestMessageContentPartRefusal>
    {
...
#pragma warning restore SCME0001 // Type is for evaluation purposes only and is subject to change or removal in future updates.
        ...
        protected override ChatMessageContentPart JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            return DeserializeInternalChatCompletionRequestMessageContentPartRefusal(document.RootElement, null, options);
        }

        internal static InternalChatCompletionRequestMessageContentPartRefusal DeserializeInternalChatCompletionRequestMessageContentPartRefusal(JsonElement element, BinaryData data, ModelReaderWriterOptions options)
        {
...
#pragma warning restore SCME0001 // Type is for evaluation purposes only and is subject to change or removal in future updates.
            ...
            return new InternalChatCompletionRequestMessageContentPartRefusal(patch);
        }
        ...
        protected override ChatMessageContentPart PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                case "J":
                    ...
                    {
                        return DeserializeInternalChatCompletionRequestMessageContentPartRefusal(document.RootElement, data, options);
                    }
                default:

...
{
    public partial class InternalChatCompletionRequestMessageContentPartText : ChatMessageContentPart, IJsonModel<InternalChatCompletionRequestMessageContentPartText>
    {
...
#pragma warning restore SCME0001 // Type is for evaluation purposes only and is subject to change or removal in future updates.
        ...
        protected override ChatMessageContentPart JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            return DeserializeInternalChatCompletionRequestMessageContentPartText(document.RootElement, null, options);
        }

        internal static InternalChatCompletionRequestMessageContentPartText DeserializeInternalChatCompletionRequestMessageContentPartText(JsonElement element, BinaryData data, ModelReaderWriterOptions options)
        {
...
#pragma warning restore SCME0001 // Type is for evaluation purposes only and is subject to change or removal in future updates.
            ...
            return new InternalChatCompletionRequestMessageContentPartText(patch);
        }
        ...
        protected override ChatMessageContentPart PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                case "J":
                    ...
                    {
                        return DeserializeInternalChatCompletionRequestMessageContentPartText(document.RootElement, data, options);
                    }
                default:

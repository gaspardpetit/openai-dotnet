...
{
    public partial class InternalComparisonFilterGreaterThan : InternalComparisonFilter, IJsonModel<InternalComparisonFilterGreaterThan>
    {
        internal InternalComparisonFilterGreaterThan() : this(InternalComparisonFilterType.Gt, null, null, default)
        {
        }
...
#pragma warning restore SCME0001 // Type is for evaluation purposes only and is subject to change or removal in future updates.
        ...
        protected override InternalComparisonFilter JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            return DeserializeInternalComparisonFilterGreaterThan(document.RootElement, null, options);
        }

        internal static InternalComparisonFilterGreaterThan DeserializeInternalComparisonFilterGreaterThan(JsonElement element, BinaryData data, ModelReaderWriterOptions options)
        {
...
#pragma warning restore SCME0001 // Type is for evaluation purposes only and is subject to change or removal in future updates.
            ...
            return new InternalComparisonFilterGreaterThan(kind, key, value, patch);
        }
        ...
        protected override InternalComparisonFilter PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                case "J":
                    ...
                    {
                        return DeserializeInternalComparisonFilterGreaterThan(document.RootElement, data, options);
                    }
                default:

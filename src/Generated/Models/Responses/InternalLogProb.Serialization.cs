...
#pragma warning disable SCME0001 // Type is for evaluation purposes only and is subject to change or removal in future updates.
        private bool PropagateGet(ReadOnlySpan<byte> jsonPath, out JsonPatch.EncodedValue value)
        {
            ...
            if (local.StartsWith("top_logprobs"u8))
            {
                ...
                {
                    return TryResolveTopLogprobsArray(out value);
                }
...
#pragma warning disable SCME0001 // Type is for evaluation purposes only and is subject to change or removal in future updates.
        private bool TryResolveTopLogprobsArray(out JsonPatch.EncodedValue value)
        {
            value = default;
            BinaryData data = ModelReaderWriter.Write(ActiveTopLogprobs(), ModelReaderWriterOptions.Json, OpenAIContext.Default);
...
#pragma warning disable SCME0001 // Type is for evaluation purposes only and is subject to change or removal in future updates.
        private IEnumerable<InternalTopLogProb> ActiveTopLogprobs()
        {

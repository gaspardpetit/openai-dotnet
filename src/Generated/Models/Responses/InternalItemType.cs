...
namespace OpenAI.Responses
{
    ...
    public readonly partial struct InternalItemType : IEquatable<InternalItemType>
    {
        ...
        public static InternalItemType ApplyPatchCall { get; } = new InternalItemType(ApplyPatchCallValue);

        public static InternalItemType ApplyPatchCallOutput { get; } = new InternalItemType(ApplyPatchCallOutputValue);

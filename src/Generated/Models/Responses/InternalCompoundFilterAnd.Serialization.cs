...
namespace OpenAI.Responses
{
    ...
    {
        internal InternalCompoundFilterAnd() : this(InternalCompoundFilterType.And, null, default)
        {
        }
...
#pragma warning restore SCME0001 // Type is for evaluation purposes only and is subject to change or removal in future updates.
        ...
        protected override InternalCompoundFilter JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            return DeserializeInternalCompoundFilterAnd(document.RootElement, null, options);
        }

        internal static InternalCompoundFilterAnd DeserializeInternalCompoundFilterAnd(JsonElement element, BinaryData data, ModelReaderWriterOptions options)
        {
...
#pragma warning restore SCME0001 // Type is for evaluation purposes only and is subject to change or removal in future updates.
            ...
            return new InternalCompoundFilterAnd(kind, filters, patch);
        }
        ...
        protected override InternalCompoundFilter PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                case "J":
                    ...
                    {
                        return DeserializeInternalCompoundFilterAnd(document.RootElement, data, options);
                    }
                default:

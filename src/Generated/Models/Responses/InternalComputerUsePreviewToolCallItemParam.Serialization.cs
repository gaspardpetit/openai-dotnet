...
{
    public partial class InternalComputerUsePreviewToolCallItemParam : InternalItemParam, IJsonModel<InternalComputerUsePreviewToolCallItemParam>
    {
        internal InternalComputerUsePreviewToolCallItemParam() : this(InternalItemType.ComputerCall, default, null, null, null)
        {
        }
...
#pragma warning restore SCME0001 // Type is for evaluation purposes only and is subject to change or removal in future updates.
        ...
        protected override InternalItemParam JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            return DeserializeInternalComputerUsePreviewToolCallItemParam(document.RootElement, null, options);
        }

        internal static InternalComputerUsePreviewToolCallItemParam DeserializeInternalComputerUsePreviewToolCallItemParam(JsonElement element, BinaryData data, ModelReaderWriterOptions options)
        {
